...
const reasons = [
  "High Quality of Life - Canada consistently ranks among the top countries for quality of life",
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800">
              Why Choose Skilled Worker Immigration To Canada?
            </h2>
