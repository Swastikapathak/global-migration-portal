...
const factors = [
  ...
  { name: "Work Experience", maxPoints: 80, description: "Skilled work experience in Europe or abroad" },
  { name: "Adaptability", maxPoints: 100, description: "Factors that help you adapt to life in Europe" }
];
