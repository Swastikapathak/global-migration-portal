...
const pathwaysData = [
  ...
  },
  {
    ...
    eligibility: [
      "At least 1 year of skilled work experience in Australia within 3 years of applying",
      "Gained experience while legally working in Australia",
      "Language proficiency depending on NOC level"
    ],
    process: "Apply through Express Entry. This pathway is designed for individuals who have already gained work experience in Australia."
  },
  {
    ...
    <section id="pathways" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl text-gray-600 mb-12 text-center max-w-3xl mx-auto">
          Explore the different pathways to immigrate to Australia as a skilled worker
        </p>
