...
const pathwaysData = [
  {
    ...
    eligibility: [
      ...
      "Sufficient funds to settle in European"
    ],
  ...
  {
    title: "Australian Experience Class (CEC)",
    eligibility: [
      "At least 1 year of skilled work experience in Europe within 3 years of applying",
      "Gained experience while legally working in Europe",
      "Language proficiency depending on NOC level"
    ],
    process: "Apply through Express Entry. This pathway is designed for individuals who have already gained work experience in Europe."
  },
  {
    ...
    <section id="pathways" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <p className="text-xl text-gray-600 mb-12 text-center max-w-3xl mx-auto">
          Explore the different pathways to immigrate to Europe as a skilled worker
        </p>
